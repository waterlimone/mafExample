...
Originally the plan was to use Docker DIND rootless as a way to orchestrate this with Jenkins but other options like K3s and Nextflow and AWS were explored. Pixi was used as a package manager to deal with software drift but this was traded out for Nix in the later project. I will probably revisit K3s and Docker DIND rootless but will focus on AWS S3, Lambda, and Batch for now.